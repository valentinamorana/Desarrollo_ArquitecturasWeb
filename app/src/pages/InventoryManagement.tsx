    ...
    <div className="portal-layout">
      ...
      <main className="portal-main">
        <header className="page-header">
          <div className="header-text">
            <h2 className="display-text">Inventory Ledger</h2>
            <p className="subtitle">Comprehensive management of the Atelier's shared collection.</p>
          </div>
        ...
        <div className="filter-bar bg-surface-low">
          <div className="search-input">
            ...
            <input type="text" placeholder="Search by ID, name, or category..." />
          </div>
        ...
        <div className="ledger-container bg-surface-lowest">
            ...
            <tbody>
              <tr>
                ...
                <td className="item-cell">
                  ...
                  <span className="item-name">Charcoal Wool Overcoat</span>
                </td>
                <td className="category-cell">Outerwear</td>
                <td>Central Hub - Bin A4</td>
                <td>Oct 12, 2023</td>
              ...
              <tr className="rented-row">
                ...
                <td className="item-cell">
                  ...
                  <span className="item-name">Emerald Silk Gown</span>
                </td>
                <td className="category-cell">Evening Wear</td>
          ...
          <footer className="ledger-footer">
            <span>Showing 1-15 of 2,482 Garments</span>
      ...
      <aside className="item-detail-sidebar glass-card editorial-shadow">
        ...
        <div className="item-overview">
           ...
           <h3>Emerald Silk Gown</h3>
           <p className="detail-meta">ID: WF-3419 • Evening Wear</p>
           <span className="badge rented lg">Currently Rented</span>
        </div>
        <div className="sidebar-section">
           ...
           <div className="rental-card bg-surface-low">
             ...
             <div>
               ...
               <p className="due-date">Due: Nov 15, 2023</p>
             </div>
           </div>
        </div>
      </aside>
